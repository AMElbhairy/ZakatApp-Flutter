...
class AppLocalizations {
  ...
  _values = <String, Map<String, String>>{
    ...
    'ar': <String, String>{
      ...
      'lock_message': 'افتح زكاة والث للمتابعة.',
      'unlock': 'فتح القفل',
      'use_biometric_or_passcode': 'استخدم {biometric} / رمز المرور',
      ...
      'backup_before_sign_out_message':
          'يمكن لزكاة والث نسخ بياناتك احتياطياً أولاً، ثم مسح هذا الجهاز وإعادتك إلى شاشة تسجيل الدخول.',
      'sign_out_anyway': 'تسجيل الخروج على أي حال',
      'backup_now': 'نسخ احتياطي الآن',
      'backup_failed_title': 'فشل النسخ الاحتياطي',
      'backup_failed_message':
          'تعذر إكمال النسخ الاحتياطي. يمكنك المحاولة مرة أخرى أو تسجيل الخروج على أي حال.',
