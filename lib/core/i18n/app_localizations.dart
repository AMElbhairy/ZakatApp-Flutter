...
class AppLocalizations {
  ...
  _values = <String, Map<String, String>>{
    'en': <String, String>{
      ...
      'export_json_backup': 'Export JSON Backup',
      'import_json_backup': 'Import JSON Backup',
      'export_csv_excel': 'Export Excel / CSV',
      'import_csv_excel': 'Import Excel / CSV',
      'export_csv_sheet_title': 'Export Entries (Excel / CSV)',
      'export_all_zip': 'Export All Entries (Excel Zip)',
      'export_master_csv': 'Export Master CSV (All Data)',
      'export_transactions_csv': 'Export Transactions Only',
      'export_savings_csv': 'Export Savings & Accounts Only',
      'export_investments_csv': 'Export Investments & Properties Only',
      'export_recurring_csv': 'Export Recurring Only',
      'csv_import_preview_title': 'Excel / CSV Import Preview',
      'csv_import_no_account_data_note':
          'Only entries and records are imported. Your account credentials and security settings remain untouched.',
      'csv_merge_action': 'Merge Import (Add & Update)',
      'csv_replace_action': 'Replace Entries (Entries Only)',
      ...
      'remind_me_about_payment': 'Remind me about payment',
      'remind_me': 'Remind Me',
      ...
      'total_other_liabilities': 'Total Other Liabilities',
      'no_liabilities_yet': 'No liabilities added yet',
      'liabilities_empty_message':
          'Add a liability to keep track of what you owe.',
      ...
      'delete_credit_card_message':
          'The card will be archived and removed from this list.',
      'activity': 'Activity',
      'plans': 'Plans',
      'account': 'Account',
      'add_entry': 'Add Entry',
      ...
      'how_calculation_works_subtitle':
          'Learn how your method and Nisab are calculated',
      ...
      'transfer_destination': 'Destination account',
      'smart_capture_disabled': 'Smart Capture is disabled in Settings.',
      'gold': 'Gold',
      'silver': 'Silver',
      'property': 'Property',
    ...
    'ar': <String, String>{
      ...
      'export_json_backup': 'تصدير نسخة احتياطية JSON',
      'import_json_backup': 'استيراد نسخة احتياطية JSON',
      'export_csv_excel': 'تصدير ملف Excel / CSV',
      'import_csv_excel': 'استيراد ملف Excel / CSV',
      'export_csv_sheet_title': 'تصدير البيانات (Excel / CSV)',
      'export_all_zip': 'تصدير كافة البيانات (ملف Zip مضغوط)',
      'export_master_csv': 'تصدير ملف CSV موحد (كافة البيانات)',
      'export_transactions_csv': 'تصدير المعاملات المالية فقط',
      'export_savings_csv': 'تصدير المدخرات والحسابات فقط',
      'export_investments_csv': 'تصدير الاستثمارات والعقارات فقط',
      'export_recurring_csv': 'تصدير المعاملات المتكررة فقط',
      'csv_import_preview_title': 'معاينة استيراد Excel / CSV',
      'csv_import_no_account_data_note':
          'يتم استيراد البيانات والمعاملات فقط دون المساس ببيانات الحساب أو الإعدادات الأمنية.',
      'csv_merge_action': 'دمج مع البيانات الحالية',
      'csv_replace_action': 'استبدال البيانات فقط',
      ...
      'pay_credit_card': 'سداد بطاقة ائتمانية',
      'payment_amount': 'مبلغ السداد',
      'payment': 'سداد',
      'cards': 'بطاقات',
      'loans': 'القروض',
      'total_liabilities': 'إجمالي الالتزامات',
      'available_credit': 'متاح',
      'total_owed': 'إجمالي المستحق',
      'utilization': 'نسبة الاستخدام',
      'add_credit_card': 'إضافة بطاقة ائتمانية',
      'edit_credit_card': 'تعديل البطاقة الائتمانية',
      'card_details': 'تفاصيل البطاقة',
      'bank_issuer': 'البنك / الجهة المصدرة',
      'card_nickname': 'اسم البطاقة',
      'card_network': 'شبكة البطاقة',
      'last_4_digits': 'آخر 4 أرقام',
      'credit_limit': 'الحد الائتماني',
      'current_balance_owed': 'الرصيد المستحق الحالي',
      'minimum_payment_due': 'الحد الأدنى للسداد',
      'add_card': 'إضافة البطاقة',
      'save_changes': 'حفظ التغييرات',
      'card_theme': 'لون البطاقة',
      'card_appearance': 'مظهر البطاقة',
      'card_information': 'معلومات البطاقة',
      'financial_details': 'التفاصيل المالية',
      'billing_cycle': 'دورة الفوترة',
      'statement_day': 'يوم كشف الحساب',
      'payment_due_day': 'يوم استحقاق السداد',
      'payment_reminder': 'تذكير بالدفع',
      'remind_me_about_payment': 'تذكيري بالدفع',
      'remind_me': 'تذكيري',
      ...
      'notes': 'ملاحظات',
      'metals': 'المعادن',
      'gold_and_silver': 'الذهب والفضة',
      'vehicles': 'المركبات',
      'other_liabilities': 'التزامات أخرى',
      'total_other_liabilities': 'إجمالي الالتزامات الأخرى',
      'no_liabilities_yet': 'لم تتم إضافة التزامات بعد',
      'liabilities_empty_message': 'أضف التزاماً لمتابعة ما عليك.',
      'on_due_date': 'في يوم الاستحقاق',
      '1_day_before': 'قبل يوم واحد',
      '2_days_before': 'قبل يومين',
      '3_days_before': 'قبل 3 أيام',
      '5_days_before': 'قبل 5 أيام',
      '7_days_before': 'قبل 7 أيام',
      'custom': 'مخصص',
      'owed': 'مستحق',
      'delete_credit_card': 'هل تريد حذف البطاقة الائتمانية؟',
      'delete_credit_card_message':
          'ستتم أرشفة البطاقة وإزالتها من هذه القائمة.',
      'activity': 'السجل',
      'plans': 'الخطط',
      'account': 'حسابي',
      ...
      'cash': 'نقد',
      'deduct_from': 'الخصم من',
      'deposit_to': 'إيداع في',
      'transfer_source': 'الحساب المصدر',
      'transfer_destination': 'الحساب الوجهة',
      'smart_capture_disabled': 'التقاط العمليات الذكي معطل من الإعدادات.',
      'gold': 'ذهب',
      'silver': 'فضة',
      'property': 'عقار',
      ...
      'zakatable_wealth': 'الخاضع للزكاة',
      ...
      'depreciation_rate': 'معدل الاستهلاك السنوي (%)',
      'total_loan_amount': 'إجمالي قيمة القرض',
      'repeat': 'تكرار',
