...
class BackupErrorPresenter {
  ...
  static String getFriendlyMessage(String? technicalError, BuildContext context) {
    ...
    if (lower.contains('403') || lower.contains('permissiondenied') || lower.contains('permission_denied')) {
      return isArabic
    ...
    // 7. Timeout
    if (lower.contains('timeout') || lower.contains('timed out') || lower.contains('errno = 60')) {
      return isArabic
    ...
    if (lower.contains('corrupt') || lower.contains('damaged') || lower.contains('checksum mismatch') || lower.contains('mac check failed')) {
      return isArabic
    ...
    if (lower.contains('incompatible') || lower.contains('schema') || lower.contains('app version') || lower.contains('update the app')) {
      return isArabic
